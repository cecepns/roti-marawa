        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Roti Marawa</span>
            </div>
            <p className="text-cream-200 mb-4">
              Roti Marawa menghadirkan roti segar berkualitas tinggi dengan resep tradisional 
              yang telah turun temurun. Dibuat dengan bahan-bahan pilihan terbaik.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-cream-200">
              <li>📧 info@rotimarawa.com</li>
              <li>📞 +62 123 456 789</li>
              <li>📍 Jl. Roti Manis No. 123, Jakarta</li>
            </ul>
          </div>
        </div>
